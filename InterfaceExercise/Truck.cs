...
namespace InterfaceExercise
{
    internal class Truck : IVehicle, ICompany
    {
        ...
        public void DisplayDetails()
        {
            ...
            Console.WriteLine($"Is my truck a pickup: {IsPickup}");
            Console.WriteLine($"Does it have Dual rear wheels: {HasDualWheels}");
            ...
            //
            //Console.WriteLine($"{IsPickup},{HasDualWheels},{NumberOfWheels},{IsAutomatic},{IsElectric},{NumberOfDoors},{CountryOrgin},{Logo}");
        }
    }
}
